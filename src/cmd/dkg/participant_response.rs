...
pub struct DkgParticipantResponse {
    ...
    is_accepted: bool, /* Indicates whether the participant accepted or
                        * declined the invite */
}
...
impl DkgParticipantResponse {
    ...
    pub fn session(&self) -> ARID { self.session }

    pub fn is_accepted(&self) -> bool { self.is_accepted }
}
...
impl TryFrom<Envelope> for DkgParticipantResponse {
    ...
    fn try_from(envelope: Envelope) -> bc_envelope::Result<Self> {
        ...
        let is_accepted: bool =
            envelope.try_object_for_predicate("is_accepted")?;
